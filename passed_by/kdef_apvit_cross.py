...
def main():
    ...
    plt.grid()    
    plt.savefig(os.path.join('pic/apvit','theta_{}_gamma_{}_beta_{}_lr_{}.png').format(opt.theta,opt.gamma,opt.beta,opt.learning_rate))
    ...
    with open(os.path.join('pic/apvit','theta_{}_gamma_{}_beta_{}_lr_{}.pkl').format(opt.theta,opt.gamma,opt.beta,opt.learning_rate),'wb') as f:
              pickle.dump(accu_data,f)    
