...
from networks.resnet_big2 import SupConResNet
...
def parse_option():
    ...
    opt.model_name = '{}3_{}_{}_lr_{}_decay_{}_bsz_{}_temp_{}_trial_{}'.\
...
def set_model(opt):
    ...
    criterion2 = BTLoss(batch_size=opt.batch_size, beta=opt.beta)
...
def train(train_loader, model, criterion, criterion2, optimizer, epoch, opt):
    ...
    for idx, (images, labels) in enumerate(train_loader):
        ...
        # print(loss)
        loss += criterion2(mid1[:opt.batch_size], mid1[opt.batch_size:])
        loss += criterion2(mid2[:opt.batch_size], mid2[opt.batch_size:])
