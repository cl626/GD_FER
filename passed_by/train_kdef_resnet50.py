...
def parse_option():
    ...
    opt.model_name = '{}_{}_ori_resnet50_lr_{}_decay_{}_bsz_{}_temp_{}_trial_{}'.\
...
def set_model(opt):
    ...
    # model.load_state_dict({k.replace('module.',''):v for k,v in torch.load('./save/SupCon/cifar10_models/SupCon3_cifar10_resnet50_0.5_0.02_0.5_lr_0.5_decay_0.0001_bsz_64_temp_0.1_trial_0_cosine/cl_kdef_last.pth')['model'].items()})
...
def main():
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        # perform test
        if(epoch%5 ==0):
            test(train_loader, model, criterion, criterion2, epoch)
