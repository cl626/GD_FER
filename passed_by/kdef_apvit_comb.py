...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='kdef',
                        choices=['ddcf', 'kdef'], help='dataset')
    ...
    if(opt.method == 'Cross'):
        opt.model_name = '{}_{}_{}_{}_{}_bsz_{}_epoch_{}_lr_{}_decay_{}_bsz_{}_temp_{}_trial_{}'.\
        ...
        opt.model_name = '{}_{}_{}_bsz_{}_epoch_{}_ratio_{}_alpha_{}_beta_{}_gamma_{}_lr_{}_decay_{}_bsz_{}_temp_{}_trial_{}'.\
...
def set_model(opt):    
    model = APViT(pret='save/SupCon/kdef_IR_50_models/SupCon_kdef_IR_50_bsz_256_epoch_500_ratio_0.01_theta_1.0_alpha_0.0_beta_0.001_gamma_0.5_lr_0.01_decay_0.0001_bsz_256_temp_0.1_trial_0_cosine/last.pth')
...
#     )
    # model.load_state_dict(torch.load('save/SupCon/kdef_IR_50_models/SupCon_kdef_IR_50_bsz_256_epoch_500_ratio_0.01_theta_1.0_alpha_0.0_beta_0.001_gamma_0.5_lr_0.01_decay_0.0001_bsz_256_temp_0.1_trial_0_cosine/cl_kdef_last.pth')['model'])
...
def main():
    ...
    with open('datasets/kdef/kdef_norm_train_32.pkl','rb') as f:
        train_loader = pickle.load(f)
    
    with open('datasets/kdef/kdef_norm_test_32.pkl','rb') as f:
    ...
    plt.grid()    
    plt.savefig(os.path.join('pic/apvit','theta_{}_gamma_{}_beta_{}.png').format(opt.theta,opt.gamma,opt.beta))
    ...
    with open(os.path.join('pic/apvit','theta_{}_gamma_{}_beta_{}.pkl').format(opt.theta,opt.gamma,opt.beta),'wb') as f:
              pickle.dump(accu_data,f)    
