...
def set_model(opt):
    ...
    model.load_state_dict({k.replace('module.',''):v for k,v in torch.load('./save/SupCon/cifar10_models/SupCon_cifar10_resnet50_lr_0.5_decay_0.0001_bsz_64_temp_0.1_trial_0_cosine/last.pth')['model'].items()})
    model.head.add_module("linear1",nn.Linear(128,10))
...
def main():
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        # perform test
        # if(epoch% 5==0):
        test(train_loader, model, criterion, epoch)
